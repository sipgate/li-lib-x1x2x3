...
/**
 * <p>Java class for HashContext complex type.
 *
...
public class HashContext extends GenericObject implements Copyable, PartialCopyable {
  ...
  @Override
  public HashContext createCopy(final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
    final HashContext _newObject = ((HashContext) super.createCopy(_propertyTree, _propertyTreeUse));
    final PropertyTree hashAlgorithmPropertyTree =
      ((_propertyTree == null) ? null : _propertyTree.get("hashAlgorithm"));
    if (
      ((_propertyTreeUse == PropertyTreeUse.INCLUDE)
  ...
  @Override
  public HashContext copyExcept(final PropertyTree _propertyTree) {
    return createCopy(_propertyTree, PropertyTreeUse.EXCLUDE);
  }

  @Override
  public HashContext copyOnly(final PropertyTree _propertyTree) {
  ...
  public static class Select extends HashContext.Selector<HashContext.Select, Void> {

    Select() {
      super(null, null, null);
    }

    public static HashContext.Select _root() {
      return new HashContext.Select();
    }
  }

  public static class Selector<TRoot extends com.kscs.util.jaxb.Selector<TRoot, ?>, TParent>
    extends GenericObject.Selector<TRoot, TParent> {

    private com.kscs.util.jaxb.Selector<TRoot, HashContext.Selector<TRoot, TParent>> hashAlgorithm = null;
    private com.kscs.util.jaxb.Selector<TRoot, HashContext.Selector<TRoot, TParent>> salt = null;
    ...
    public Map<String, PropertyTree> buildChildren() {
      ...
      if (this.hashAlgorithm != null) {
        products.put("hashAlgorithm", this.hashAlgorithm.init());
      }
      if (this.salt != null) {
        products.put("salt", this.salt.init());
      }
      return products;
    }

    public com.kscs.util.jaxb.Selector<TRoot, HashContext.Selector<TRoot, TParent>> hashAlgorithm() {
      return (
        (this.hashAlgorithm == null)
          ? this.hashAlgorithm = new com.kscs.util.jaxb.Selector<>(this._root, this, "hashAlgorithm")
          : this.hashAlgorithm
      );
    }

    public com.kscs.util.jaxb.Selector<TRoot, HashContext.Selector<TRoot, TParent>> salt() {
      return (
        (this.salt == null) ? this.salt = new com.kscs.util.jaxb.Selector<>(this._root, this, "salt") : this.salt
      );
    }
  }
}
