...
/**
 * <p>Java class for ServiceScopingOptions complex type.
 *
...
public class ServiceScopingOptions implements Copyable, PartialCopyable {
  ...
  public ServiceScopingOptions(
    ...
    if (
      ...
      this.serviceType = ((_other.serviceType == null)
          ? null
          : _other.serviceType.createCopy(serviceTypePropertyTree, _propertyTreeUse));
    }
    ...
    if (
      ...
      this.locationType = ((_other.locationType == null)
          ? null
          : _other.locationType.createCopy(locationTypePropertyTree, _propertyTreeUse));
    }
  ...
  @Override
  public ServiceScopingOptions createCopy(final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
    final ServiceScopingOptions _newObject;
    try {
      _newObject = ((ServiceScopingOptions) super.clone());
    } catch (CloneNotSupportedException e) {
    ...
    if (
      ...
      _newObject.serviceType = ((this.serviceType == null)
          ? null
          : this.serviceType.createCopy(serviceTypePropertyTree, _propertyTreeUse));
    }
    final PropertyTree locationTypePropertyTree = ((_propertyTree == null) ? null : _propertyTree.get("locationType"));
    if (
      ((_propertyTreeUse == PropertyTreeUse.INCLUDE)
      ...
      _newObject.locationType = ((this.locationType == null)
          ? null
          : this.locationType.createCopy(locationTypePropertyTree, _propertyTreeUse));
    }
    final PropertyTree suspendOnOutboundInternationalRoamingPropertyTree =
      ((_propertyTree == null) ? null : _propertyTree.get("suspendOnOutboundInternationalRoaming"));
    if (
  ...
  @Override
  public ServiceScopingOptions copyExcept(final PropertyTree _propertyTree) {
    return createCopy(_propertyTree, PropertyTreeUse.EXCLUDE);
  }

  @Override
  public ServiceScopingOptions copyOnly(final PropertyTree _propertyTree) {
  ...
  public static class Select extends ServiceScopingOptions.Selector<ServiceScopingOptions.Select, Void> {

    Select() {
      super(null, null, null);
    }

    public static ServiceScopingOptions.Select _root() {
      return new ServiceScopingOptions.Select();
    }
  }
  ...
  public static class Selector<TRoot extends com.kscs.util.jaxb.Selector<TRoot, ?>, TParent>
    ...
    private ListOfServiceTypes.Selector<TRoot, ServiceScopingOptions.Selector<TRoot, TParent>> serviceType = null;
    private LocationTypeOptions.Selector<TRoot, ServiceScopingOptions.Selector<TRoot, TParent>> locationType = null;
    private com.kscs.util.jaxb.Selector<
      TRoot,
      ServiceScopingOptions.Selector<TRoot, TParent>
    > suspendOnOutboundInternationalRoaming = null;
    private com.kscs.util.jaxb.Selector<TRoot, ServiceScopingOptions.Selector<TRoot, TParent>> reportPostDialledDigits =
      null;
    ...
    public Map<String, PropertyTree> buildChildren() {
      ...
      if (this.suspendOnOutboundInternationalRoaming != null) {
        products.put("suspendOnOutboundInternationalRoaming", this.suspendOnOutboundInternationalRoaming.init());
      }
      if (this.reportPostDialledDigits != null) {
        products.put("reportPostDialledDigits", this.reportPostDialledDigits.init());
      }
      return products;
    }

    public ListOfServiceTypes.Selector<TRoot, ServiceScopingOptions.Selector<TRoot, TParent>> serviceType() {
      return (
        (this.serviceType == null)
          ? this.serviceType = new ListOfServiceTypes.Selector<>(this._root, this, "serviceType")
          : this.serviceType
      );
    }

    public LocationTypeOptions.Selector<TRoot, ServiceScopingOptions.Selector<TRoot, TParent>> locationType() {
      return (
        (this.locationType == null)
          ? this.locationType = new LocationTypeOptions.Selector<>(this._root, this, "locationType")
          : this.locationType
      );
    }
    ...
    > suspendOnOutboundInternationalRoaming() {
      return (
        (this.suspendOnOutboundInternationalRoaming == null)
          ? this.suspendOnOutboundInternationalRoaming = new com.kscs.util.jaxb.Selector<>(
            this._root,
            this,
            "suspendOnOutboundInternationalRoaming"
          )
          : this.suspendOnOutboundInternationalRoaming
      );
    }
    ...
    > reportPostDialledDigits() {
      return (
        (this.reportPostDialledDigits == null)
          ? this.reportPostDialledDigits = new com.kscs.util.jaxb.Selector<>(
            this._root,
            this,
            "reportPostDialledDigits"
          )
          : this.reportPostDialledDigits
      );
    }
  }
}
