...
/**
 * <p>Java class for ExtensionInformation complex type.
 *
...
public class ExtensionInformation implements Copyable, PartialCopyable {
  ...
  @Override
  public ExtensionInformation createCopy(final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
    final ExtensionInformation _newObject;
    try {
      _newObject = ((ExtensionInformation) super.clone());
    } catch (CloneNotSupportedException e) {
  ...
  @Override
  public ExtensionInformation copyExcept(final PropertyTree _propertyTree) {
    return createCopy(_propertyTree, PropertyTreeUse.EXCLUDE);
  }

  @Override
  public ExtensionInformation copyOnly(final PropertyTree _propertyTree) {
  ...
  public static class Select extends ExtensionInformation.Selector<ExtensionInformation.Select, Void> {

    Select() {
      super(null, null, null);
    }

    public static ExtensionInformation.Select _root() {
      return new ExtensionInformation.Select();
    }
  }
  ...
  public static class Selector<TRoot extends com.kscs.util.jaxb.Selector<TRoot, ?>, TParent>
    ...
    private com.kscs.util.jaxb.Selector<TRoot, ExtensionInformation.Selector<TRoot, TParent>> extensionSpecification =
      null;
    private com.kscs.util.jaxb.Selector<
      TRoot,
      ExtensionInformation.Selector<TRoot, TParent>
    > extendedRequestMessageType = null;
    ...
    public Map<String, PropertyTree> buildChildren() {
      ...
      if (this.extensionSpecification != null) {
        products.put("extensionSpecification", this.extensionSpecification.init());
      }
      if (this.extendedRequestMessageType != null) {
        products.put("extendedRequestMessageType", this.extendedRequestMessageType.init());
      }
      return products;
    }

    public com.kscs.util.jaxb.Selector<TRoot, ExtensionInformation.Selector<TRoot, TParent>> extensionSpecification() {
      return (
        (this.extensionSpecification == null)
          ? this.extensionSpecification = new com.kscs.util.jaxb.Selector<>(this._root, this, "extensionSpecification")
          : this.extensionSpecification
      );
    }
    ...
    > extendedRequestMessageType() {
      return (
        (this.extendedRequestMessageType == null)
          ? this.extendedRequestMessageType = new com.kscs.util.jaxb.Selector<>(
            this._root,
            this,
            "extendedRequestMessageType"
          )
          : this.extendedRequestMessageType
      );
    }
  }
}
