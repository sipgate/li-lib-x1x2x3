...
/**
 * <p>Java class for HashedIdentifier complex type.
 *
...
public class HashedIdentifier implements Copyable, PartialCopyable {
  ...
  @Override
  public HashedIdentifier createCopy(final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
    final HashedIdentifier _newObject;
    try {
      _newObject = ((HashedIdentifier) super.clone());
    } catch (CloneNotSupportedException e) {
  ...
  @Override
  public HashedIdentifier copyExcept(final PropertyTree _propertyTree) {
    return createCopy(_propertyTree, PropertyTreeUse.EXCLUDE);
  }

  @Override
  public HashedIdentifier copyOnly(final PropertyTree _propertyTree) {
  ...
  public static class Select extends HashedIdentifier.Selector<HashedIdentifier.Select, Void> {

    Select() {
      super(null, null, null);
    }

    public static HashedIdentifier.Select _root() {
      return new HashedIdentifier.Select();
    }
  }
  ...
  public static class Selector<TRoot extends com.kscs.util.jaxb.Selector<TRoot, ?>, TParent>
    ...
    private com.kscs.util.jaxb.Selector<TRoot, HashedIdentifier.Selector<TRoot, TParent>> hashContextID = null;
    private com.kscs.util.jaxb.Selector<TRoot, HashedIdentifier.Selector<TRoot, TParent>> targetIdentityType = null;
    private com.kscs.util.jaxb.Selector<TRoot, HashedIdentifier.Selector<TRoot, TParent>> hashDigest = null;
    ...
    public Map<String, PropertyTree> buildChildren() {
      ...
      if (this.hashContextID != null) {
        products.put("hashContextID", this.hashContextID.init());
      }
      if (this.targetIdentityType != null) {
        products.put("targetIdentityType", this.targetIdentityType.init());
      }
      if (this.hashDigest != null) {
        products.put("hashDigest", this.hashDigest.init());
      }
      return products;
    }

    public com.kscs.util.jaxb.Selector<TRoot, HashedIdentifier.Selector<TRoot, TParent>> hashContextID() {
      return (
        (this.hashContextID == null)
          ? this.hashContextID = new com.kscs.util.jaxb.Selector<>(this._root, this, "hashContextID")
          : this.hashContextID
      );
    }

    public com.kscs.util.jaxb.Selector<TRoot, HashedIdentifier.Selector<TRoot, TParent>> targetIdentityType() {
      return (
        (this.targetIdentityType == null)
          ? this.targetIdentityType = new com.kscs.util.jaxb.Selector<>(this._root, this, "targetIdentityType")
          : this.targetIdentityType
      );
    }

    public com.kscs.util.jaxb.Selector<TRoot, HashedIdentifier.Selector<TRoot, TParent>> hashDigest() {
      return (
        (this.hashDigest == null)
          ? this.hashDigest = new com.kscs.util.jaxb.Selector<>(this._root, this, "hashDigest")
          : this.hashDigest
      );
    }
  }
