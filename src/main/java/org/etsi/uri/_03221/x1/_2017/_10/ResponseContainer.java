...
public class ResponseContainer implements Copyable, PartialCopyable {
      ...
      if (_other.x1ResponseMessage == null) {
        ...
        for (X1ResponseMessage _item : _other.x1ResponseMessage) {
          this.x1ResponseMessage.add(
              ((_item == null) ? null : _item.createCopy(x1ResponseMessagePropertyTree, _propertyTreeUse))
            );
        }
      }
    }
   ...
   * This is why there is not a {@code set} method for the x1ResponseMessage property.
   *
   * <p>
  ...
  @Override
  public ResponseContainer createCopy(final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
    final ResponseContainer _newObject;
    try {
      _newObject = ((ResponseContainer) super.clone());
    } catch (CloneNotSupportedException e) {
    ...
    if (
      ...
      if (this.x1ResponseMessage == null) {
        ...
        _newObject.x1ResponseMessage = new ArrayList<>();
        for (X1ResponseMessage _item : this.x1ResponseMessage) {
          _newObject.x1ResponseMessage.add(
            ((_item == null) ? null : _item.createCopy(x1ResponseMessagePropertyTree, _propertyTreeUse))
          );
        }
      }
  ...
  @Override
  public ResponseContainer copyExcept(final PropertyTree _propertyTree) {
    return createCopy(_propertyTree, PropertyTreeUse.EXCLUDE);
  }

  @Override
  public ResponseContainer copyOnly(final PropertyTree _propertyTree) {
  ...
  public static class Select extends ResponseContainer.Selector<ResponseContainer.Select, Void> {

    Select() {
      super(null, null, null);
    }

    public static ResponseContainer.Select _root() {
      return new ResponseContainer.Select();
    }
  }
  ...
  public static class Selector<TRoot extends com.kscs.util.jaxb.Selector<TRoot, ?>, TParent>
    ...
    private X1ResponseMessage.Selector<TRoot, ResponseContainer.Selector<TRoot, TParent>> x1ResponseMessage = null;
    ...
    public Map<String, PropertyTree> buildChildren() {
      ...
      if (this.x1ResponseMessage != null) {
        products.put("x1ResponseMessage", this.x1ResponseMessage.init());
      }
      return products;
    }

    public X1ResponseMessage.Selector<TRoot, ResponseContainer.Selector<TRoot, TParent>> x1ResponseMessage() {
      return (
        (this.x1ResponseMessage == null)
          ? this.x1ResponseMessage = new X1ResponseMessage.Selector<>(this._root, this, "x1ResponseMessage")
          : this.x1ResponseMessage
      );
    }
  }
}
